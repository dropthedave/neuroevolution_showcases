...
class StdGP:
	...
	def fit(self,Tr_x, Tr_y, Te_x = None, Te_y = None):
		if self.verbose:
			...
			print("    > #Fitness Tournaments (sf): "+str(self.sf))
			print("    > #Size Tournaments (sp):    "+str(self.sp))
			print("    > Switch:      				"+str(self.switch))
			print("    > Tournament size:      		"+str(self.n))
	...
	def nextGeneration(self):
		...
		while len(newPopulation) < self.population_size:
			offspring = getOffspring(self.rng, self.population, self.sf, self.sp, self.n ,self.switch )
